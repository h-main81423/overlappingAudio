(() => {
        ...
        squares.forEach((square, index) => {
          ...
          if (bullet.y <= (square.y + square.y2) && bullet.y > square.y && bullet.x > square.x && bullet.x < (square.x + square.x2)) {
            ...
            // create and play explosion sound
             ...
             explosion.src = "audio/chinkennunget.mp3"; //added audio source
    
             document.body.appendChild(explosion); //added the element to the page    
  ...
  function createBullet() {
    ...
    //creates an <audio></audio> element
    laser.src = "audio/laser.mp3"; //added audio source
    
    document.body.appendChild(laser); //added the element to the page    
